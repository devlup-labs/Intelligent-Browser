...
export default function Home() {
  ...
  const messagesEndRef = useRef<HTMLDivElement | null>(null); //so to scroll to current message
  const [active, setActive] = useState('new'); //sidebar me kaun  active hai
  ...
  const handleWorkflowMessage = (data: any) => {
    ...
    // 
      ...
      const isTaskCompleted = data.status === "SUCCESS";
  ...
  //This works because websocket me token send karna mushkil ho jata
  useEffect(() => {
